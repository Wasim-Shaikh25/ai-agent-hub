...
if(!T)location.href='/superadmin-login';
...
const VIEWS={
 ...
 orgs(){guard(async()=>{
   ...
   M.innerHTML='<div class="hdr"><h1>Organizations</h1></div>'+
   '<div class="card"><h2>Register a new organization</h2><div class="row"><div style="flex:2"><label>Org name</label><input id="oname" placeholder="Acme Engineering"/></div><div style="flex:1"><label>Slug</label><input id="oslug" placeholder="acme"/></div><div style="flex:2"><label>Admin email</label><input id="oadmin" placeholder="admin@acme.com"/></div><div style="flex:0"><label>&nbsp;</label><button onclick="createOrg()">Add</button></div></div>'+
