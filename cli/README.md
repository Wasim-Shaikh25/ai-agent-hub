...
aihub connect kiro                 # -> .kiro/settings/mcp.json
...
`detect` scans your machine for installed/running agents (Cursor, Kiro,
Windsurf, VS Code, and CLI agents on PATH) and reports them to the Hub, where
they appear in the **Agents & Models** tab; `--connect` also wires each one up.
